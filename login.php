  ...
  <div class="limiter">
    <div class="container-login100">
      ...
      <div class="wrap-login100">
        <div class="login100-pic js-tilt" data-tilt  style="background: #FFFFFF;">
          <img src="images/login2.png" style="width: ;object-fit: contain; height: "; alt="PNG">
        </div>
      ...
      <!--     <div class="text-center p-t-12">
          ...
          <div class="text-center p-t-136">
			...
			<a class="txt2" href="http://localhost/dashboard/DSC_Solution_Challenge_2021/es/index.php">
              Examination Portal
              <i class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i>
            </a>
          </div>
