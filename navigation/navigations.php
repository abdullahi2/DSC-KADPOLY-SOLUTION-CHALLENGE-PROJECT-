...
<title><?php echo $title;?> DSC Solution Challenge 2021</title>
...
#footer > footer { 
  background-color: rgb(72, 244, 86);
  min-height: 40px;
  padding: 10px; 
  border-top: 1px solid #ddd;
  color:#fff;
...
#lesson {
    top: 180px;
    background-color: rgb(6, 196, 254)
}
...
#login {
    top: 500px;
    background-color: rgb(124, 131, 125);
}
...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="">STUDENT EDUCATIONAL GUIDE & E-LEARNING PLATFORM FOR STUDENTS
      <p class="subtitle"> </p> 
  </div>
</section>  
...
<footer  >
    <p align="left">&copy; DSC Solution Challenge 2021</p>
</footer>
</section>
